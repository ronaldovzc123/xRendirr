...
public class AprobarSolicitud extends AppCompatActivity {

    FirebaseFirestore db;
    ListView lista;

    Registro RegistroSelec;
    EditText fechaSol, dni,fechaDesde,fechaHasta,motivo,descripcion,centro,importe,desde,hasta,uid,estado;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_aprobar_solicitud);
       ...
       // ListarDatos();
        ...
        lista.setOnItemClickListener(new AdapterView.OnItemClickListener() {
            ...
            public void onItemClick(AdapterView<?> parent, View view, int position, long id) {
                ...
                if(Estado.equals("Por_Aprobar_Solicitud")){
                    ...
                    Intent add = new Intent(AprobarSolicitud.this, AprobarSolicitud_Registro.class);
        ...
        db.collection("xRendir").whereEqualTo("ruc", Ruc).get().addOnCompleteListener(new OnCompleteListener<QuerySnapshot>() {
            ...
            public void onComplete(@NonNull Task<QuerySnapshot> task) {
                ...
                if(task.isSuccessful()){
                    ...
                    adaptador.getFilter().filter("Por_Aprobar_Solicitud");
        ...
        db.collection("xRendir").orderBy("fechaHora", Query.Direction.DESCENDING).get().addOnCompleteListener(new OnCompleteListener<QuerySnapshot>() {
            ...
            public void onComplete(@NonNull Task<QuerySnapshot> task) {
                ...
                for(QueryDocumentSnapshot document : task.getResult()) {
                    ...
                    arrayAdapterRegistro = new ArrayAdapter<Registro>(AprobarSolicitud.this, android.R.layout.simple_list_item_1, listRegistro);
        ...
        switch (item.getItemId())
        {
            case R.id.icon_back:
            {
               // Intent add = new Intent(AprobarSolicitud.this, MenuInicio.class);
                ...
                Toast.makeText(AprobarSolicitud.this, "Atras",Toast.LENGTH_SHORT).show();
                break;
            }
        }
        return true;
