...
public class AprobarSolicitud_Registro extends AppCompatActivity {
...
usuarios usuarioSelec;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_aprobar_solicitud__registro);
    ...
    public boolean onCreateOptionsMenu(Menu menu) {
        getMenuInflater().inflate(R.menu.menu04,menu);
        return true;
    }
    ...
    public boolean onOptionsItemSelected(MenuItem item) {
        switch (item.getItemId()) {
            case R.id.Aprobar: {
                ...
                r.setRuc(Ruc);
                r.setFecha(Fecha);
                r.setNombres_Apellidos(nombres.getText().toString().trim());
                r.setFechaSolicitud(FechaSol);
                r.setFechaHora(fechashora);
                r.setHora(Hora);

                r.setEstadoSolicitud("Solicitud_Aprobada");
            ...
            case R.id.Rechazar: {
                ...
                r.setEstadoSolicitud("Solicitud_Rechazada");
            ...
            docRef.get().addOnCompleteListener(new OnCompleteListener<DocumentSnapshot>() {
                ...
                public void onComplete(@NonNull Task<DocumentSnapshot> task) {
                    if(task.isSuccessful()) {
                        ...
                        Toast.makeText(AprobarSolicitud_Registro.this, "DNI No Registrado", Toast.LENGTH_SHORT).show();
                    }
