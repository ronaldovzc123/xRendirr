    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        lista.setOnItemClickListener(new AdapterView.OnItemClickListener() {
            ...
            public void onItemClick(AdapterView<?> parent, View view, int position, long id) {
                ...
                if(Estado.equals("Por_Liquidar")){
                    ...
                    Intent add = new Intent(Liquidacion.this, Liquidacion_documentos.class);
        ...
        /*Lista2.setOnItemClickListener(new AdapterView.OnItemClickListener() {
            ...
            public void onItemClick(AdapterView<?> parent, View view, int position, long id) {
                ...
                if(Estado.equals("Liquidacion_Rechazada")){
...
/*
        ...
        db.collection("xRendir").whereEqualTo("dni", DNI).get().addOnCompleteListener(new OnCompleteListener<QuerySnapshot>() {
            ...
            public void onComplete(@NonNull Task<QuerySnapshot> task) {
                ...
                if(task.isSuccessful()){
                    ...
                    adaptador.getFilter().filter("Por_Liquidar");

                   // adaptador.getFilter().filter("Liquidacion_Rechazada");
    ...
    /*
    public void CargarDatos2(final Activity activity)
    {
        usuarioSelec = new usuarios();
        Bundle extras = getIntent().getExtras();
        String DNI = extras.getString("DNI");
        ...
        db.collection("xRendir").whereEqualTo("dni", DNI).get().addOnCompleteListener(new OnCompleteListener<QuerySnapshot>() {
            ...
            public void onComplete(@NonNull Task<QuerySnapshot> task) {
                ...
                if(task.isSuccessful()){
                    ...
                    ListView itemListView = (ListView) findViewById(R.id.Lista2);
        ...
        db.collection("xRendir").orderBy("fechaHora", Query.Direction.DESCENDING).get().addOnCompleteListener(new OnCompleteListener<QuerySnapshot>() {
            ...
            public void onComplete(@NonNull Task<QuerySnapshot> task) {
                ...
                for(QueryDocumentSnapshot document : task.getResult()) {
                    ...
                    arrayAdapterRegistro = new ArrayAdapter<Registro>(Liquidacion.this, android.R.layout.simple_list_item_1, listRegistro);
    ...
    public boolean onOptionsItemSelected(MenuItem item) {
        switch (item.getItemId())
        {
            case R.id.icon_back:
            {
                ...
                Toast.makeText(Liquidacion.this, "Atras",Toast.LENGTH_SHORT).show();
                break;
            }
        }
        return true;
